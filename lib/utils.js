...
// @TODO:  centralize logging into a logger class using bunyan - 0.8.x-alpha
const print = {
...
async function checkIfExists (fileName, altPath=null) {
  // @TODO:  refactor to use util.promisify - 0.7.x-alpha
  return new Promise((resolve, reject) => {
    // read-only on the file
    fs.open(altPath ? altPath : getPath(fileName), 'r', err => {
